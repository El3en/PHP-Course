                ...
                foreach($products as $product){
                  ...
                  <td class='align-middle'>
                    ...
                    >
                      ...
                      />
                      <div class='input-group-btn'>
                      <a href='incQuantity.php?id={$product['product']['id']}'>
                        <button
                          type='button'
                  ...
                  <td class='align-middle'>$({$product['product']['price']} - ({$product['product']   ['price']} * {$product['product']['discount']}))
                  </td>
                  <td class='align-middle'>
                    <a href='removeProduct.php?id={$product['product']['id']}'>
